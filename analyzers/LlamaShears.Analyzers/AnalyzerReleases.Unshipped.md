...
LS0007  | LlamaShears.Style  | Error    | Identifiers may not abbreviate to 'ct' or 'cts' (any case/underscore variant) — covers parameters, fields, properties, locals, foreach, catch, and pattern designators. Spell them 'cancellationToken' / 'cancellationTokenSource'.
