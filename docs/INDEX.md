...
- [Heartbeat](design/heartbeat.md): per-agent autonomous wake-up — tick-checked timing, file-driven prompt, disabled by missing/empty file or non-positive period.
