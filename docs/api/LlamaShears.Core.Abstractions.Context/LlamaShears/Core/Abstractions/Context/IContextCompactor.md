...
### `CompactAsync`([AgentContext](AgentContext.md) agentContext, ModelPrompt prompt, ILanguageModel model, ModelConfiguration configuration, bool force, CancellationToken cancellationToken)
