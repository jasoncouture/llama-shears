...
- [IContextCompactor](IContextCompactor.md) — Decides whether a [ModelPrompt](../Provider/ModelPrompt.md) needs compaction and commits a summary plus the preserved tail. Does not call the model; the pipeline launches a compaction child for the summary.
