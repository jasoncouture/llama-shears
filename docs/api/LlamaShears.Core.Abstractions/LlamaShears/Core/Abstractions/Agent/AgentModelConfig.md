...
### `AgentModelConfig`([CompositeIdentity](../Provider/CompositeIdentity.md) Id, [ThinkLevel](../Provider/ThinkLevel.md) Think, Nullable<int> ContextLength, Nullable<TimeSpan> KeepAlive, int TokenLimit, Nullable<JsonElement> Options)
