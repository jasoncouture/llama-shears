...
- [SlashCommandContext](SlashCommandContext.md) — Per-invocation input for an [ISlashCommand](ISlashCommand.md). Carries the session the command is acting on plus the positional arguments parsed from the input line.
