# LlamaShears.Core.Abstractions.Provider.IContextCompactor

Assembly: `LlamaShears.Core.Abstractions`

Decides whether a [ModelPrompt](ModelPrompt.md) exceeds the model's
...
### `CompactAsync`([AgentContext](../Context/AgentContext.md) agentContext, [ModelPrompt](ModelPrompt.md) prompt, [ILanguageModel](ILanguageModel.md) model, [ModelConfiguration](ModelConfiguration.md) configuration, bool force, CancellationToken cancellationToken)
