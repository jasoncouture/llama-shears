...
- `ModelId` — Provider-scoped identifier; pair with the provider name to get a globally unique [CompositeIdentity](../Common/CompositeIdentity.md).
...
Provider-scoped identifier; pair with the provider name to get a globally unique [CompositeIdentity](../Common/CompositeIdentity.md).
