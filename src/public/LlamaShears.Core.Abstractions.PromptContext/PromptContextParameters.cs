...
/// point of authorship.
/// </summary>
/// <param name="Now">Current wall-clock time as a <see cref="DateTimeOffset"/>; the template formats it (Scriban <c>date.to_string</c>) so the wire format stays in template authorship rather than C#.</param>
