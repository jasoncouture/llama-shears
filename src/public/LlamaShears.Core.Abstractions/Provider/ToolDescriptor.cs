...
/// <param name="Annotations">Behavior hints (destructive / idempotent / open-world / read-only) propagated from the source's MCP tool annotations. Lets host code and confirmation gates reason about side effects without re-deriving them.</param>
