...
public sealed class TodoTools
{
    ...
    [McpServerTool(Name = "todo_update", Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "todo_delete", OpenWorld = false)]
    ...
    [McpServerTool(Name = "todo_clear", Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "todo_list", Destructive = false, OpenWorld = false, ReadOnly = true)]
