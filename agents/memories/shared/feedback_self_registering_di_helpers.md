...
- Same logic applies elsewhere: when adding a new "register one of N" helper, audit whether its consumer is also auto-registered, and check before adding new fan-in helpers.
